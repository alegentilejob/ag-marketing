      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 h-28 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 md:gap-8">
          ...
          <Link
            ...
            className="hidden md:flex group items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-none text-[11px] font-bold uppercase tracking-widest shadow-lg hover:shadow-xl transition-all"
          >
        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <Link
              ...
              className="mt-4 bg-blue-600 text-white text-center py-4 text-sm font-bold uppercase tracking-widest shadow-lg"
            >
