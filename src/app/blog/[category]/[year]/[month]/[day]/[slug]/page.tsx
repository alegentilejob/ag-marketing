          ...
          <div className="space-y-16 text-left">
            {project.content.map((block, index) => {
              switch (block.type) {
                case 'text':
                  return (
                    <FadeIn key={index} delay={0.1 * index} className="prose prose-xl dark:prose-invert max-w-none prose-headings:font-bold prose-a:text-blue-500 prose-a:font-bold prose-a:underline decoration-blue-500/30 hover:decoration-blue-500 transition-all font-light">
